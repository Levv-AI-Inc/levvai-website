...
export default function CreateSOWPage() {
  ...
  const [selected, setSelected] = useState<string | null>(sow.workType || null)
  const [otherText, setOtherText] = useState(sow.otherWorkDescription || '')
  ...
  const saveDraft = (completedStep?: SOWProgressStep) => {
    if (selected) {
      setSOW({
        workType: selected,
        otherWorkDescription: selected === 'other' ? otherText : undefined,
      ...
      <div className="max-w-7xl mx-auto px-10 py-12 grid grid-cols-[1fr_300px] gap-12">
        ...
        <div className="space-y-10">
          <header className="space-y-2">
            ...
            <p className="text-gray-600 font-medium">What type of work is this engagement for?</p>
          </header>
          ...
          <div className="space-y-6">
            ...
            <footer className="flex justify-end items-center pt-10 border-t border-gray-200 mt-10">
              <button
